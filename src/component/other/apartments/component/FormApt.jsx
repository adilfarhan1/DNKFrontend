            ...
            <div className="bg-[#fff] px-7 py-5  rounded-xl">
              ...
              <form onSubmit={handleSubmit}>
                <div className="flex flex-col justify-between mx-[0px] md:mx-[10px] mt-3 md:mt-0">
                  ...
                  <div>
                    <button
                      className="bg-[#997A5D] hover:bg-[#000] hover:text-[#997A5D] text-[#fff] w-full p-[10px] mt-[25px] rounded duration-100 flex justify-center mb-3"
                      disabled={loading}
                    >
                      {loading ? (
              ...
              <div className="bg-gradient-to-br from-[#BCA68B] to-[#997A5D] px-8 py-5 rounded-xl md:max-w-[800px]">
                <div className="flex justify-end">
                  <div className="flex gap-1 items-center mb-4">
                    ...
                    <p className="m-0 text-[#fff]">NEWS</p>
                  </div>
                </div>
