...
export const PopupClick = ({ data, onFormSubmit, onClose, imageUrl }) => {
          ...
          <div className="!pt-0 p-4 md:p-5 space-y-4">
            <form onSubmit={handleSubmit}>
              <div className="flex flex-col justify-between mx-[0px] md:mx-[10px] mt-3 md:mt-0">
                <div>
                  <p className="m-0 text-[#A4815C]">More About</p>
                ...
                <div>
                  <button
                    className="bg-[#A4815C] hover:bg-[#ffffff] hover:text-[#A4815C] w-full p-[10px] mt-[25px] rounded duration-100 flex justify-center"
                    disabled={loading}
                  >
                    {loading ? (
