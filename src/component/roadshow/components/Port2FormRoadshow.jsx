...
export const Port2FormRoadshow = () => {
  ...
  const { postClientResgisterPort2, getRoadshow, checkDuplicateClient } =
  ...
  const initialState = {
    ...
    email: "",
    phone: "91",
    event: "Ahmedabad Event - APR ( 19-20) 2025",
    attendDate: "",
    attendTime: "",
    sourcedRm: "",
  };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (duplicateCheck.duplicate) {
        ...
        const response = await postClientResgisterPort2({
      ...
      <div className="grid sm:grid-cols-2">
        ...
        <div className="mx-2 mb-[25px]">
          ...
          >
            ...
            <option className="text-[#000000]" value={"19th-Apr-2025"}>
              SAT 19th April
            </option>
            <option className="text-[#000000]" value={"20th-Apr-2025"}>
              SUN 20th April
            </option>
          </select>
          {errors.attendDate && (
...
export default Port2FormRoadshow;
