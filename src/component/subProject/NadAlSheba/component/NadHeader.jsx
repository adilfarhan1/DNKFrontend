...
import dnkLogo from "../../../../assets/pojects/NadAlSheba/meraas-logo.webp";
import { IoClose } from "react-icons/io5";
import { useLocation } from "react-router-dom";
import PopupNad from "./PopupNad";

export const NadHeader = () => {
  ...
  return (
    <div>
              ...
              <nav className="">
                <ul className="items-center justify-center gap-4 ">
                  ...
                  >
                    ...
                    <span
                      className={
                        "absolute bottom-0 left-0 w-full h-0.5 bg-[#258493] rounded origin-bottom-right transform transition duration-200 ease-out scale-x-0 group-hover:scale-x-100 group-hover:origin-bottom-left"
                      }
                    ></span>
                  </li>
                  <li
      ...
      <div>{ShowPopup && <PopupNad onClose={() => setShowPopup(false)} />}</div>
    </div>
  );
};
