...
export const ADTalkFooterForm = ({ onFormSubmit }) => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      <div className="flex flex-col justify-between mx-[0px] md:mx-[10px] mt-3 md:mt-0">
        ...
        <div>
          <button
            className="bg-[#ffffff] hover:bg-[#0D84C8] text-[#000000] hover:text-[#ffffff] w-full p-[10px] mt-[25px] rounded duration-100 flex justify-center"
            disabled={loading}
          >
            {loading ? (
